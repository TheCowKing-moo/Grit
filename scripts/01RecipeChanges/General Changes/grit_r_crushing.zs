...
import mods.mekanism.crusher;
  ...
  while ( i < dirtCrush.length - 1 ) {
      ...
      //mods.horsepower.Grindstone.add(<input> IItemStack, <output> IItemStack, <time> Integer, <hand> Boolean, <secondary> ItemStack, <chance> Integer )
      mods.horsepower.Grindstone.add( dirtCrush[i].items[0], dirt.items[0], 3, false, sand.items[0], 50 );
      ...
      mods.betterwithmods.Mill.addRecipe( [dirtCrush[i]], [dirt.items[0], sand.items[0]] );
